...
map.getView().fit([2356007.729355, 6882789.080416, 2401625.197951, 6913231.731066], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Analiza przebiegu koryta rzeki Bug 1940-2024</h2>';
        return titleElement;
    })(),
